...
tape('Browser offline mode', function (assert) {
  ...
  client.once(client.Event.SDK_READY, function () {
    ...
    const expectedSplitView1 = {
      name: 'testing_split', trafficType: 'localhost', killed: false, changeNumber: 0, treatments: ['on'], configs: {}, sets: [], defaultTreatment: 'control', impressionsDisabled: false, prerequisites: []
    };
    const expectedSplitView2 = {
      name: 'testing_split_with_config', trafficType: 'localhost', killed: false, changeNumber: 0, treatments: ['off'], configs: { off: '{ "color": "blue" }' }, sets: [], defaultTreatment: 'control', impressionsDisabled: false, prerequisites: []
    };
    assert.deepEqual(manager.names(), ['testing_split', 'testing_split_with_config']);
    ...
    client.once(client.Event.SDK_UPDATE, async (metadata) => {
      ...
      const expectedSplitView3 = {
        name: 'testing_split_with_config', trafficType: 'localhost', killed: false, changeNumber: 0, treatments: ['nope'], configs: {}, sets: [], defaultTreatment: 'control', impressionsDisabled: false, prerequisites: []
      };
